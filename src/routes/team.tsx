...
export const TEAM = [
  { role: "Chairman", name: "Muzammil Abdul Khader", img: director, bio: "Muzammil Abdul Khader serves as Chairman of Life Care Medical Polyclinic & Day Care Centre and helps shape the clinic's long-term healthcare vision.", slug: "/chairman-muzammil-abdul-khader" },
  { role: "Chairman", name: "Zulman Saeed", img: chairman, bio: "Zulman Saeed is recognized as a Chairman of Life Care and supports the organization’s growth, service quality and community healthcare commitment.", slug: "/chairman-zulman-saeed" },
  { role: "CEO", name: "T.K Muhammad Safeem", img: ceo, bio: "T.K Muhammad Safeem serves as CEO of Life Care and leads daily operations with focus on patient care, service standards and trusted medical delivery.", slug: "/ceo-t-k-muhammad-safeem" },
  { role: "Managing Director", name: "Mansoor Ahmad", img: md, bio: "Mansoor Ahmad supports Life Care as Managing Director and helps coordinate leadership priorities across clinical and operational functions.", slug: null },
];
    ...
    <SiteShell>
      ...
      <section className="mx-auto max-w-7xl px-4 pb-24">
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {TEAM.map((m) => {
            const card = (
              <div className="card-lift rounded-3xl border border-border bg-card shadow-soft overflow-hidden">
            ...
            if (m.slug) {
              return (
                <Link key={m.name} to={m.slug as string} className="block">
                  {card}
                </Link>
              );
            }
